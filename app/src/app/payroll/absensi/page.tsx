  ...
  return (
    <main className="min-h-screen bg-neutral-950 px-6 py-10 text-neutral-100 md:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-2 text-neutral-400">Absen tanpa mesin fingerprint fisik — otomatis flag telat/lembur.</p>
        ...
        <Card className="mt-8 flex flex-col items-center py-10 text-center">
          ...
          <motion.button
            ...
            className={`mt-6 flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-medium text-white transition ${
        ...
        <h2 className="mt-10 mb-3 text-sm font-medium text-neutral-300">Status Tim Hari Ini</h2>
        <Card>
