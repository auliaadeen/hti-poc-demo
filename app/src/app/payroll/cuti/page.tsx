  ...
  return (
    <main className="min-h-screen bg-neutral-950 px-6 py-10 text-neutral-100 md:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-2 text-neutral-400">Atasan langsung → HR. Tanpa form kertas.</p>

        <Card className="mt-8">
          <p className="mb-4 text-sm font-medium text-neutral-300">Form Pengajuan</p>
          {!submitted ? (
            <div className="space-y-3">
              <select className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm">
                <option>Cuti Tahunan</option>
                <option>Izin</option>
                <option>Sakit</option>
              </select>
              <div className="grid grid-cols-2 gap-3">
                <input type="date" className="rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm" />
                <input type="date" className="rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm" />
              </div>
              <textarea placeholder="Alasan singkat" className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm" rows={2} />
              ...
              <motion.button
                ...
                className="rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-600"
              >
                Ajukan
              </motion.button>
            </div>
        ...
        <h2 className="mt-10 mb-3 text-sm font-medium text-neutral-300">Riwayat Pengajuan</h2>
                ...
                <div className="mt-3 border-t border-neutral-800 pt-3">
                  {c.riwayat.map((r, i) => (
                    <p key={i} className="text-xs text-neutral-500">
                      {r.level}: <span className="text-neutral-300">{r.aksi}</span> — {r.tanggal}
                    </p>
                  ))}
                </div>
              </Card>
