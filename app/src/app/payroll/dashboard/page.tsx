      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <Card className="lg:col-span-1">
            <p className="mb-4 text-sm font-medium text-neutral-300">Status Absensi Hari Ini</p>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {pieData.map((d) => (
                <span key={d.name} className="flex items-center gap-1.5 text-xs text-neutral-400">
          ...
          <Card className="lg:col-span-2">
            <p className="mb-4 text-sm font-medium text-neutral-300">Status Kepatuhan Payroll</p>
            <div className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-400">Payroll periode Agustus 2026</span>
                <Badge tone="warning">Belum Dijalankan</Badge>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-400">Perhitungan BPJS Kesehatan & Ketenagakerjaan</span>
                <Badge tone="success">Otomatis — Tarif Terkini</Badge>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-400">Perhitungan PPh 21 (skema TER)</span>
                <Badge tone="success">Otomatis — Tarif Terkini</Badge>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-400">Slip gaji periode sebelumnya</span>
                <Badge tone="neutral">4 dari 4 terunduh</Badge>
              </div>
            </div>
            <Link
              href="/payroll/payroll-run"
              className="mt-5 inline-block rounded-lg bg-blue-700 px-4 py-2 text-xs font-medium text-white hover:bg-blue-600"
            >
