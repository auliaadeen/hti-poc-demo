...
- [ ] Data karyawan (profil, jabatan, gaji pokok, status kontrak)
- [ ] Struktur organisasi & jenjang approval
- [ ] Absensi online (check-in/out, deteksi telat/lembur otomatis)
- [ ] Pola kerja/shift dasar
- [ ] Cuti/izin/sakit dengan approval berjenjang + upload surat
- [ ] Payroll engine: gaji pokok + lembur + tunjangan + potongan otomatis
- [ ] Perhitungan PPh 21 otomatis sesuai skema TER terkini
- [ ] Perhitungan BPJS Kesehatan & Ketenagakerjaan otomatis sesuai tarif terkini
- [ ] Slip gaji PDF otomatis per periode
- [ ] Rekap/laporan payroll (per periode, exportable)
- [ ] Portal ESS karyawan (self-service: absen, cuti, slip gaji)
- [ ] Dashboard admin (HR) + dashboard ringkas direksi
- [ ] Auth & role-based access (admin, HR, karyawan)
